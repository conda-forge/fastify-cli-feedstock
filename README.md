...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/fastify-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fastify-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fastify-cli
# for installing globally
pixi global install fastify-cli
```
...
It is possible to list all of the versions of `fastify-cli` available on your platform:
...
```
pixi search fastify-cli --channel conda-forge
```
